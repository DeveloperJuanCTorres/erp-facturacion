...
class TransactionUtil extends Util
{
    ...
    public function createSellTransaction($business_id, $input, $invoice_total, $user_id, $uf_data = true)
    {
        ...
        $transaction = Transaction::create([
            ...
            'custom_field_categoria' => ! empty($input['custom_field_categoria']) ? $input['custom_field_categoria'] : null,
            'custom_field_fabricacion' => ! empty($input['custom_field_fabricacion']) ? $input['custom_field_fabricacion'] : null,
            'custom_field_carroceria' => ! empty($input['custom_field_carroceria']) ? $input['custom_field_carroceria'] : null,
            'custom_field_uso' => ! empty($input['custom_field_uso']) ? $input['custom_field_uso'] : null,
            'custom_field_poliza' => ! empty($input['custom_field_poliza']) ? $input['custom_field_poliza'] : null,
            'custom_field_actividad' => ! empty($input['custom_field_actividad']) ? $input['custom_field_actividad'] : null,
    ...
    public function getListSellsTotal($business_id, $sale_type = 'sell')
    {
        ...
        $sells = Transaction::leftJoin('contacts', 'transactions.contact_id', '=', 'contacts.id')
                ...
                ->select(
                    ...
                    DB::raw('SUM(tsl.quantity - tsl.so_quantity_invoiced) as so_qty_remaining'),
                    'transactions.is_export',
                    'transactions.response_sunat',
                    'transactions.response_nota_sunat',
                    'transactions.status_sunat',
